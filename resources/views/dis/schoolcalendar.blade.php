...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- Small Box (Stat card) -->
        <h5 class="mb-2 mt-4"><strong>Event's portal</strong></h5>
            ...
            <div class="card-header">
                    <h3 class="card-title">
                            <button type="button" class="btn btn-block btn-outline-info btn-sm"
                                data-toggle="modal" data-target="#eventregistration" disabled>Register new event</button>
                    </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <table id="teachers_attendance" class="table table-bordered table-striped" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align='center'><strong>{{ $school_name[$calendar->school_id] }}</strong></td>
                            ...
                            @if(Auth::user()->id == $calendar->create_id || Auth::user()->hasRole("Head") || Auth::user()->hasRole("Deputy Head"))
                            <td align='center'>
                                    ...
                                    <a class="delete-calendar" href="{{route('calender.destroy',[$calendar->id])}}">
                                    <font color='red'>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('calender.store') }}">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('calender.update',[$calendar->id]) }}">
