                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-3 col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min='0' class="form-control" id="glastName"
                                                aria-describedby="" placeholder="" name="max_marks_p3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min='0' class="form-control" id="glastName"
                                                aria-describedby="" placeholder="" name="max_marks_p4">
                                        </div>
                                    </div>
                                    @endif
                                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align='center'><input type='number' min=0 step=0.1
                                        name="paper_2_<?php print_r($class_student->student_id);?>" /></td>
                                <td align='center'><input type='number' min=0 step=0.1
                                        name="paper_3_<?php print_r($class_student->student_id);?>" /></td>
                                @elseif($subject_papers == 4)
                                <td align='center'><input type='number' min=0 step=0.1
                                        name="paper_1_<?php print_r($class_student->student_id);?>" /></td>
                                <td align='center'><input type='number' min=0 step=0.1
                                ...
                                <td align='center'><input type='number' min=0 step=0.1
                                        name="paper_3_<?php print_r($class_student->student_id);?>" /></td>
                                <td align='center'><input type='number' min=0 step=0.1
                                        name="paper_4_<?php print_r($class_student->student_id);?>" /></td>
                                @endif
                                <!--td align='center'>
