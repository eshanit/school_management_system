            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @endif
                        <li class="nav-item">
                        @if(Auth::user()->hasRole("dis"))
                        <a href="{{ route('calender.show',[$school_id])}}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                
                                        <button type="button" class="btn btn-danger btn-block">
                                               School Calendar <span class="badge badge-light"></span>
                                        </button>
                                </p>
                            </a>

                        @else
                        <a href="{{ route('calender.show',[Auth::user()->school_id])}}" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                
                                        <button type="button" class="btn btn-danger btn-block">
                                                Calendar <span class="badge badge-light"></span>
                                        </button>
                                </p>
                            </a>
                        @endif
