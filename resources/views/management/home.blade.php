...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3>{{ $schoolgradeclasses ->count() }}</h3>
        ...
        <div class="card">
            ...
            <table id="school_classes" class="table table-bordered table-striped" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i++}}</td>
                            <td>{{$schoolgradeclass->grade}}{{$schoolgradeclass->subclasses}}</td>
                            @if(isset($teachername[$schoolgradeclass->id]))
                                <td>{{$teachername[$schoolgradeclass->id]}}</td>
                            @else
                            <td>-</td>
                            @endif
                            ...
                            @endif
                            <td>
                            @if(isset($teacherclass_teacher_id[$schoolgradeclass->id]))
                                <a role="button" class="btn btn-block btn-outline-info btn-sm" href="{{ route('class_teacher.show',$teacherclass_teacher_id[$schoolgradeclass->id])}}">Get in</a>
                            @else
        ...
        <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                            @if(Auth::user()->hasRole("Head") || Auth::user()->hasRole("Deputy Head"))
                            <h3 class="card-title"><button type="button" class="btn btn-block btn-outline-info btn-sm"
                                ...
                                @else
                                <h3 class="card-title"><button type="button" class="btn btn-block btn-outline-info btn-sm"
                                    data-toggle="modal" data-target="#studentregistration" disabled>Register new student</button>
                            </h3>
                             @endif
                    </h3>
                </div>
                    ...
                    <table id="students" class="table table-bordered table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 @if(isset($student_class[$student->student_id]))
                                   <td align='center'><strong><font color='#ac0f16'>{{ $student_class[$student->student_id] }}</font></strong> <span style="cursor:pointer" data-toggle="modal"
                                            data-target="#editClassStudent_<?php print_r($student->student_id);?>"><strong> <i class="far fa-edit"></i> </span>
                                    </td>
                                    @else
                                    <td align='center'><button type="button" class="btn btn-sm btn-outline-success"
                                            data-toggle="modal"
                                            data-target="#addClassStudent_<?php print_r($student->student_id);?>"><strong>Add
                                                Class</strong></button>
                                    </td>
                                @endif
                                ...
                                @if(isset($student_class[$student->student_id]))
                                <td align='center'><strong><font color='#ac0f16'>{{ $student_class[$student->student_id] }}</font></strong> <span style="cursor:pointer" data-toggle="modal"
                                         data-target=""><strong> <i class="far fa-edit"></i> </span>
                                 </td>
                                 @else
                                 <td align='center'><button type="button" class="btn btn-sm btn-outline-success"
                                         data-toggle="modal"
                                         data-target=""><strong>Add
                                             Class</strong></button>
                                 </td>
                             @endif
                                ...
                                @endif
                                    ...
                                    <td align='center'>
                                        <span style="cursor:pointer">
                                            <font color='446dff'><a data-toggle="modal"
                                                    data-target="#Studentinfo_<?php print_r($student->student_id);?>"><i
                                    ...
                                    <td align='center'>
                                        <font color='orange'><span data-toggle="modal"
                                                data-target="#editStudent_<?php print_r($student->student_id);?>"
                                                style="cursor:pointer"><i class="fas fa-user-edit fa-lg"></i></span>
                                        </font> /
                                        @if(($student->activestatus_id) == 1 )
                                        <font color='red'>
                                            <a class="delete-student" data-student-id="{{$student->student_id}}"
                                        ...
                                        @else
                                        <font color='green'>
                                            <a class="undelete-student" data-student-id="{{$student->student_id}}"
                                                onclick="undeleteStudent({{ $student->student_id }})">
                                                <span style="cursor:pointer">
...
@foreach($students as $student)
<div class="modal fade" id="Studentinfo_<?php print_r($student->student_id);?>" tabindex="-1" role="dialog"
...
@foreach($students as $student)
<div class="modal fade" id="addClassStudent_<?php print_r($student->student_id);?>" tabindex="-1" role="dialog"
...
@foreach($students as $student)
<div class="modal fade" id="editStudent_<?php print_r($student->student_id);?>" tabindex="-1" role="dialog"
    aria-labelledby="editing" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('student.update',[$student->student_id]) }}">
                    {{ method_field('PUT') }}
